...
<head>
    ...
    <title>{{ config('app.name', 'Sistema de Gestão - Espetinho Caxibrema') }}</title>
...
<body class="bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 antialiased">
    ...
    <main class="min-h-screen flex flex-col items-center justify-center p-6">
        <div class="max-w-3xl w-full text-center space-y-8 bg-white dark:bg-gray-900 p-12 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800">


            <div class="space-y-4">
                <h1 class="text-5xl font-extrabold tracking-tight lg:text-6xl">
                    Espetinho <span class="text-blue-600">Caxibrema</span>
                </h1>
                <p class="text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto">
                    Sistema inteligente para gestão de estoque e fluxo de vendas. Desenvolvido para otimizar a operação gastronômica local.
                </p>
            </div>

            <div class="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                @auth
                <a href="{{ url('/dashboard') }}" class="px-8 py-4 bg-blue-600 text-white font-bold rounded-xl shadow-lg shadow-blue-200 dark:shadow-none hover:bg-blue-700 transition-all transform hover:-translate-y-1">
                    Acessar Painel de Controle
                </a>
                @else
                <a href="{{ route('login') }}" class="px-8 py-4 bg-blue-600 text-white font-bold rounded-xl shadow-lg shadow-blue-200 dark:shadow-none hover:bg-blue-700 transition-all transform hover:-translate-y-1">
                    Entrar no Sistema
                </a>
                <button
                    x-data=""
                    x-on:click="$dispatch('open-modal', 'sobre-projeto')"
                    class="px-8 py-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 font-bold rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all text-gray-800 dark:text-gray-200">
                    Sobre o Projeto
                </button>

                <x-modal name="sobre-projeto" focusable>
                    <div class="p-5 relative overflow-hidden bg-white dark:bg-gray-950">

                        <div class="absolute -top-10 -right-10 w-40 h-40 bg-emerald-500/10 rounded-full blur-3xl z-0"></div>

                        <div class="relative z-10">
                            <div class="flex items-center gap-4 border-b border-gray-100 dark:border-gray-800/50 pb-6 mb-8">
                                <span class="text-5xl">🎓</span>
                                <h2 class="text-3xl md:text-4xl font-black text-gray-950 dark:text-white uppercase italic tracking-tighter leading-none">
                                    Sobre o <br>
                                    <span class="text-emerald-600 dark:text-emerald-500">Projeto de Extensão</span>
                                </h2>
                            </div>

                            <div class="mt-8 text-sm text-gray-700 dark:text-gray-300 leading-relaxed space-y-8">

                                <div class="p-6 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800/50 shadow-inner">
                                    <p>
                                        Este sistema representa o braço prático de um **Projeto de Extensão Acadêmica**. Nosso foco é aplicar o conhecimento técnico universitário para fomentar o desenvolvimento de microempreendedores locais, através da digitalização de seus processos.
                                    </p>
                                </div>

                                <div>
                                    <div class="inline-flex items-center px-4 py-1.5 rounded-full bg-emerald-100 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/50 mb-4 shadow-inner">
                                        <span class="text-xs font-semibold text-emerald-700 dark:text-emerald-400 tracking-wider uppercase">
                                            🎯 Nosso Objetivo
                                        </span>
                                    </div>
                                    <p class="pl-2">
                                        Modernizar o fluxo de trabalho do **Espetinho Caxibrema**, substituindo controles manuais por uma plataforma web robusta. Isso permite um controle preciso de estoque e o acompanhamento real do faturamento.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pl-2">
                                        <div class="flex items-center gap-3 p-4 bg-white dark:bg-gray-950 rounded-xl border border-gray-100 dark:border-gray-800/50 shadow-sm">
                                            <span class="text-2xl">🐘</span>
                                            <div>
                                                <p class="font-bold text-gray-900 dark:text-white">Laravel 11</p>
                                                <p class="text-xs text-gray-500">PHP 8.3+</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-3 p-4 bg-white dark:bg-gray-950 rounded-xl border border-gray-100 dark:border-gray-800/50 shadow-sm">
                                            <span class="text-2xl">🖌️</span>
                                            <div>
                                                <p class="font-bold text-gray-900 dark:text-white">Tailwind CSS</p>
                                                <p class="text-xs text-gray-500">UI Moderna</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-3 p-4 bg-white dark:bg-gray-950 rounded-xl border border-gray-100 dark:border-gray-800/50 shadow-sm">
                                            <span class="text-2xl">🐬</span>
                            ...
                            <div class="mt-12 pt-6 border-t border-gray-100 dark:border-gray-800/50 flex justify-end">
                                <button
                                    x-on:click="$dispatch('close')"
                                    class="p-2 px-6 py-2.5 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 font-bold rounded-lg transition-all text-xs uppercase tracking-widest">
                                    {{ __('Entendido') }}
                                </button>
                            </div>
                        </div>
            ...
            <div class="pt-8 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center text-sm text-gray-500">
                <p>📍 Aparecida de Goiânia - GO</p>
                <p>V1.0.0</p>
            </div>
        </div>

        <p class="mt-8 text-sm text-gray-400">© {{ date('Y') }} - Desenvolvido para fins acadêmicos.</p>
    </main>
</body>